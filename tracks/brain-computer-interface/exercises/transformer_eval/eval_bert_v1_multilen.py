...
from bci.decoder.transformer_bert import _EEGTransformerBert as _EEGTransformer

# bert_v1 配置（与 eval_bert_v1.py 一致）
SEED = 42
N_TIMES = 106
TEST_LENGTHS = [106, 100, 95, 90, 85, 80]
V3_DIR = Path(__file__).parent / "reports" / "bert_v1"
OUT_DIR = Path(__file__).parent / "reports" / "bert_v1_multilen"
